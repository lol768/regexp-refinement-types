...
Most Java development environments also incorporate a graphical test overview, as illustrated in figure \ref{}.
...
In this way, the integration tests are able to test the components of the system working together.
