...
\begin{titlepage}
    ...
    {\hspace{0pt}\vspace{0pt}\begin{tikzpicture}[scale=\paperwidth/1cm, overlay]
        ...
        -- (1, -0.45)
        -- (0, -0.45);
        \filldraw[draw=lightgrey,fill=id7-gray] (0.55714, 0)
        -- (0.55714, -0.45); % exclusion zone
    ...
    \vspace{1.25cm}
    \vspace{3.5cm}
    {\hspace{0.8cm}\huge\sffamily{Adam Williams}}
    \vfill
    \hspace{0pt}\todobox{Pick a better cover image which represents the topic}
    \vfill
\end{titlepage}
\restoregeometry
\restorepagecolor
