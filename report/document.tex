...
\renewcommand*\footnoterule{\hspace{-3.1cm}\noindent\makebox[\paperwidth]{\includegraphics[width=230mm]{divider}}}
...
\begin{figure}
    \begin{MyMdframed}
        ...
        \begin{adjustbox}{center}\includegraphics[width=0.9\linewidth]{snyk.png}\end{adjustbox}
    \end{MyMdframed}
\end{figure}
...
\begin{center} \includegraphics[width=0.75\linewidth]{interpet.png} \end{center}
...
\begin{figure}[H]
    \begin{MyMdframed}
        ...
        \begin{adjustbox}{center}\includegraphics[width=0.9\linewidth]{rise4fun.png}\end{adjustbox}
    \end{MyMdframed}
\end{figure}
...
\begin{figure}[H]
    \begin{MyMdframed}
        ...
        \vspace{0.5em}
        \captionsetup{style=default}
        \begin{adjustbox}{center}\includegraphics[width=0.6\linewidth]{analysers.png}\end{adjustbox}
    \end{MyMdframed}
