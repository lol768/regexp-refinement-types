...
~\\
\texttt{* Try:\\
Run with \textbf{--stacktrace} option to get the stack trace. Run with \textbf{--info} or \textbf{--debug} option to get more log output. Run with --scan to get full insights.}\\
~\\
...
38 individual passing JUnit test methods are implemented which cover the broad areas described below:
...
Automated integration tests exist to test the system end-to-end.
This means ensuring that programs parse, pass type checking and execute yielding the correct result.

\todobox{More detail, examples}

\section{Manual Testing}

\todobox{boundary conditions, adversarial input}


\chapter{Project Management}

\todobox{I can't think of a nice way to \emph{not} write this is past tense. Is it okay to use here?}
